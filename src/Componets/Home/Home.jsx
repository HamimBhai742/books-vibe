  ...
  return (
    <div className="max-w-[1170px] mx-auto mt-5 max-sm:p-3">
      <div className="bg-[#1313130D] flex max-sm:flex-col-reverse gap-3 lg:justify-between p-5 lg:p-12 rounded-2xl items-center">
        <div>
          <h3 className="font-Playfai text-3xl lg:text-6xl font-bold lg:leading-[84px] lg:max-w-[650px]">
            Books to freshen up your bookshelf
          </h3>
          <button
            onClick={handelviewListBtn}
            className="rounded-xl p-4 bg-[#23BE0A] text-white font-bold text-xl font-work-sans mt-5"
          >
            View The List
          </button>
        </div>
