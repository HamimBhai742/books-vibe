...
const Book = ({ book }) => {
    ...
    const { bookName, author, image, category, rating, bookId, tags } = book;
    console.log(book);
    return (
        <div>
            <NavLink to={`/book/${bookId}`}>
                <div>
                    <div className="card w-96 bg-base-100 border-2">
                        <div className="p-5">
                            <figure className="bg-[#F3F3F3] px-8 py-5 rounded-xl"><img className="h-[200px]" src={image} alt="Shoes" /></figure>
                        </div>
                        <div className="card-body -mt-6">
                            ...
                            <h2 className="card-title mt-2 font-Playfai text-2xl font-bold">{bookName}</h2>
                            <p className="font-medium font-work-sans text-[#131313CC]">By : {author}</p>
