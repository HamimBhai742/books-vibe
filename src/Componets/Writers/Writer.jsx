...
const Writer = ({ writer }) => {
    const { bookName, image, author, imageBook, review, yearOfPublishing, totalPages, rating } = writer
            ...
            <div className="flex border-2 font-work-sans flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
                <div className="flex space-x-4">
                    ...
                    <div className="flex flex-col space-y-1">
                        <a rel="noopener noreferrer" href="#" className="text-lg font-semibold">{author}</a>
                        <span className="text-xs dark:text-gray-600">{Math.round(rating)} hours ago</span>
                    </div>
                </div>
                <div>
